...
(function (ErrorMessage) {
    ...
    ErrorMessage["studentAlreadyInClass"] = "Student is already in the request class";
    ...
    ErrorMessage["notFound"] = "Url Not found";
...
function defautlUserError(req, res, next) {
    res.status(404).json(new API_Error(ErrorMessage.notFound));
}
exports.defautlUserError = defautlUserError;
